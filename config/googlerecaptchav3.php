...
return [
    ...
    */
    ...
    |
    */
    'secret_key' => env('RECAPTCHA_V3_SECRET_KEY', '6LeKe08kAAAAAGOzKDcRLxomplJqzwiR-8TC8QXe'),
    /*
    |--------------------------------------------------------------------------
    | Site Key
    |--------------------------------------------------------------------------
    ...
    |
    */
    'site_key' => env('RECAPTCHA_V3_SITE_KEY', '6LeKe08kAAAAAEVU12p8zE19NeTJx-tYNkEwauCI'),
